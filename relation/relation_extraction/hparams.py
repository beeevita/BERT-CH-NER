...
default_pretrained_model_path = os.path.join(here, '../pretrained_models/new-pretrained-bert')
default_train_file = os.path.join(here, '../datasets/train_known_guwen.jsonl')
default_validation_file = os.path.join(here, '../datasets/val_known_guwen.jsonl')
